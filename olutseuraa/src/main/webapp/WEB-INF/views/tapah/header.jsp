<div class="container">
<header class="header">
	<h1 class="headline  pressStart"><a onmouseover="pyoritaKuva()" onclick="randomAnimaatio()"><img id="olutKuva"  alt="olut" src="resources/img/oluttuoppi.png" width="130" height="130"></a><a href="/olutseuraa/tapahtumat">
